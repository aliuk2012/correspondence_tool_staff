...
#                                             PATCH  /cases/:id/approve(.:format)                                         cases#approve_action
#                       upload_responses_case GET    /cases/:id/upload_responses(.:format)                                cases#upload_responses
#                                             PATCH  /cases/:id/upload_responses(.:format)                                cases#upload_responses_action
#            upload_response_and_approve_case GET    /cases/:id/upload_response_and_approve(.:format)                     cases#upload_response_and_approve
#                                             PATCH  /cases/:id/upload_response_and_approve(.:format)                     cases#upload_response_and_approve_action
...
#                                             PATCH  /cases/:id/upload_response_and_return_for_redraft(.:format)          cases#upload_response_and_return_for_redraft_action
